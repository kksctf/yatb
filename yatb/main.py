...
def setup_utils(app: FastAPI) -> None:
    if settings.DEBUG:
        ...
        try:
            ...
            logger.warning("Timing debug loading")
            ...
            logger.warning("Timing debug loaded")

        except ModuleNotFoundError:
            logger.warning("No timing extensions found")
    ...
    if settings.PROFILING:
        try:
            ...
            logger.warning("pyinstrument loading")
            ...
            logger.warning("pyinstrument loaded")

        except ModuleNotFoundError:
            logger.warning("No pyinstrument found")
