...
from yatb.yatb.schema import TaskID
from yatb.yatb.utils import metrics, tg
from yatb.yatb.utils.log_helper import get_logger
from yatb.yatb.ws import ws_manager
...
async def submit_flag(user: UserDB, flag: str) -> FlagResult:
    ...
    if task.dti:
        ...
        from yatb.yatb.api.api_dynamic_tasks import UserTaskPair, get_client_safe
